...
import homeDoc from "@/doc/pages/home.json";
import searchDoc from "@/doc/pages/search.json";
import watchDoc from "@/doc/pages/watch.json";
import shortsDoc from "@/doc/pages/shorts.json";
import loginDoc from "@/doc/pages/login.json";
import registerDoc from "@/doc/pages/register.json";
import notFoundDoc from "@/doc/pages/not-found.json";
