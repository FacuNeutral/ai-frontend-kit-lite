...
//* @utility Panel lateral de comandos/atajos de teclado del debug.

import { useRef, useEffect } from "react";
import { X, Keyboard } from "lucide-react";
import { DEBUG_COMMANDS } from "../hooks/useDebugKeyboard";
...
export default function DebugCommandsPanel({ open, onClose }: DebugCommandsPanelProps) {
  ...
  const sections = DEBUG_COMMANDS.reduce<Record<string, typeof DEBUG_COMMANDS>>((acc, cmd) => {
